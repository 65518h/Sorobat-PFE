...
export class HelpComponent {
  ...
  faqs = [
    ...
    { 
      ...
      answer: 'Accédez à la section "Stock" pour voir l\'inventaire. Vous pouvez ajouter des articles, modifier les quantités, et configurer des alertes de stock minimum.' 
    }
  ];

  // Ressources
  resources = [
    { icon: '📘', title: 'Manuel utilisateur', desc: 'Guide complet d\'utilisation', link: '/docs/manual.pdf' },
    { icon: '🎬', title: 'Tutoriels vidéo', desc: 'Vidéos de démonstration', link: '/docs/videos' },
    { icon: '📋', title: 'Notes de version', desc: 'Historique des mises à jour', link: '/docs/releases' },
    { icon: '💡', title: 'Bonnes pratiques', desc: 'Conseils d\'optimisation', link: '/docs/best-practices' }
  ];
