        ...
        return this.http.get<any>(this.myProjectUrl).pipe(
          map((response: any): Project | null => {
            ...
            const project: Project = {
              ...
              personResponsible: response.personResponsible || 'Non assigné',
              projectManager: response.projectManager || 'Non assigné',
      ...
      switchMap(cachedData => {
        ...
        return forkJoin({
          ...
          map(({ project, tasks }) => {
            ...
            console.log(`📊 Projet ${project?.no}: ${tasks.length} tâches, avancement = ${avgProgress}%`);
