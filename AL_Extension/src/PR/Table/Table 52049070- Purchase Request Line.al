Table 52049070 "Purchase request Line"
{
    ...
    fields
    {
        ...
        field(5; Type; Enum "Purchase Line Type")
        {
            ...
            trigger OnValidate()
            var
                TempPurchRqLine: Record "Purchase Request line" temporary;
                IsHandled: Boolean;
            begin
                IsHandled := false;
                if IsHandled then
                ...
                if Type <> xRec.Type then begin
                    case xRec.Type of
                        Type::Item:
                            if Quantity <> 0 then begin
                                Purchr.TestField(Status, Purchr.Status::Open);
                    ...
                    if xRec."Deferral Code" <> '' then
                        DeferralUtilities.RemoveOrSetDeferralSchedule('',
                          ...
                          xRec.GetDeferralAmount(), Purchr."Posting Date", '', xRec."Currency Code", true);
                end;
                //   OnValidateTypeOnBeforeInitRec(Rec, xRec, CurrFieldNo);
                TempPurchRqLine := Rec;
                Init();
                SystemId := TempPurchRqLine.SystemId;

                if xRec."Line Amount" <> 0 then
                    "Recalculate Invoice Disc." := xRec."Allow Invoice Disc.";

                Type := TempPurchRqLine.Type;
                "System-Created Entry" := TempPurchRqLine."System-Created Entry";
        ...
        field(6; "No."; Code[20])
        {
            ...
            begin
                if RecPurchaseRq.Get(Rec."Document No.") then
                ...
                if HasTypeToFillMandatoryFields() then begin
                    Quantity := TempPurchRqLine.Quantity;
                    "Outstanding Qty. (Base)" := TempPurchRqLine."Outstanding Qty. (Base)";
                end;

                "System-Created Entry" := TempPurchRqLine."System-Created Entry";

                //    OnBeforeAssignHeaderValues(Rec, Purchr);

                GetPurchr();
                //   InitHeaderDefaults(Purchr, TempPurchLine);
                UpdateLeadTimeFields();
                UpdateDates();

                //  OnAfterAssignHeaderValues(Rec, Purchr);

                case Type of
                    Type::" ":
                        CopyFromStandardText();
                    Type::"G/L Account":
                        CopyFromGLAccount(TempPurchRqLine);
                    Type::Item:
                        CopyFromItem();
                    Type::Resource:
                        CopyFromResource();
                ...
                //   OnAfterAssignFieldsForNo(Rec, xRec, Purchr);
                ...
                if HasTypeToFillMandatoryFields() then begin
                    ...
                    InitOutstandingAndQtyToShipReceive(TempPurchRqLine);
                ...
                IsHandled := false;
                //  OnValidateNoOnBeforeJobTaskIsSet(Purchr, Rec, xRec, TempPurchLine, IsHandled);
                if not IsHandled then
...
#endif
                //  OnAfterValidateNoPurchaseLine(Rec, xRec, TempPurchLine, Purchr);
            end;
        }
        ...
        field(23; "Unit Cost (LCY)"; Decimal)
        {
            ...
            begin
                ...
                GetPurchr();
                if Purchr."Currency Code" <> '' then begin
                    Purchr.TestField("Currency Factor");
                    GetGLSetup();
                    UnitCostCurrency :=
                      Round(
                        CurrExchRate.ExchangeAmtLCYToFCY(
                          GetDate(), "Currency Code",
                          "Unit Cost (LCY)", Purchr."Currency Factor"),
            ...
            begin
                ...
                case "VAT Calculation Type" of
                    ...
                    "VAT Calculation Type"::"Reverse Charge VAT":
                        begin
                            "VAT Base Amount" :=
                              Round(Amount * (1 - Purchr."VAT Base Discount %" / 100), Currency."Amount Rounding Precision");
                            "Amount Including VAT" :=
                              Round(Amount + "VAT Base Amount" * "VAT %" / 100, Currency."Amount Rounding Precision");
                            //  OnValidateAmountOnAfterCalculateNormalVAT(Rec, Purchr, Currency);
                        end;
                    ...
                    "VAT Calculation Type"::"Sales Tax":
                        begin
                            Purchr.TestField("VAT Base Discount %", 0);
                                ...
                                "Amount Including VAT" :=
                                  ...
                                  Round(
                                    SalesTaxCalculate.CalculateTax(
                                      "Tax Area Code", "Tax Group Code", "Tax Liable", Purchr."Posting Date",
                                      "VAT Base Amount", "Quantity (Base)", Purchr."Currency Factor"),
                                    Currency."Amount Rounding Precision");
                                // OnAfterSalesTaxCalculate(Rec, Purchr, Currency);
                    ...
                    "VAT Calculation Type"::"Reverse Charge VAT":
                        begin
                            Amount :=
                              Round(
                                "Amount Including VAT" /
                                (1 + (1 - Purchr."VAT Base Discount %" / 100) * "VAT %" / 100),
                                Currency."Amount Rounding Precision");
                            "VAT Base Amount" :=
                              Round(Amount * (1 - Purchr."VAT Base Discount %" / 100), Currency."Amount Rounding Precision");
                            //  OnValidateAmountIncludingVATOnAfterCalculateNormalVAT(Rec, Purchr, Currency);
                        end;
                    "VAT Calculation Type"::"Full VAT":
                        begin
                            Amount := 0;
                                ...
                                Amount :=
                                  Round(
                                    SalesTaxCalculate.ReverseCalculateTax(
                                      "Tax Area Code", "Tax Group Code", "Tax Liable", Purchr."Posting Date",
                                      "Amount Including VAT", "Quantity (Base)", Purchr."Currency Factor"),
                                    Currency."Amount Rounding Precision");
                                //     OnAfterSalesTaxCalculateReverse(Rec, Purchr, Currency);
                                "VAT Base Amount" := Amount;
                                if "VAT Base Amount" <> 0 then
                                    "VAT %" :=
                                      Round(100 * ("Amount Including VAT" - "VAT Base Amount") / "VAT Base Amount", 0.00001)
        ...
        field(57; "Outstanding Amount"; Decimal)
        {
            ...
            begin
                ...
                if Purchr."Currency Code" <> '' then
                    "Outstanding Amount (LCY)" :=
                      Round(
                        CurrExchRate.ExchangeAmtFCYToLCY(
                          GetDate(), "Currency Code",
                          "Outstanding Amount", Purchr."Currency Factor"),
                ...
                if Purchr."Currency Code" <> '' then
                    "Amt. Rcd. Not Invoiced (LCY)" :=
                      Round(
                        CurrExchRate.ExchangeAmtFCYToLCY(
                          GetDate(), "Currency Code",
                          "Amt. Rcd. Not Invoiced", Purchr."Currency Factor"),
                        Currency2."Amount Rounding Precision")
                else
                    "Amt. Rcd. Not Invoiced (LCY)" :=
        ...
        field(70; "Vendor Item No."; Text[50])
        {
            ...
            trigger OnValidate()
            begin
                if Purchr."Send IC Document" and
        ...
        field(80; "Attached to Line No."; Integer)
        {
            ...
            Editable = false;
            TableRelation = "Purchase request line"."Line No." where("Document Type" = field("Document Type"),
        ...
        field(90; "VAT Prod. Posting Group"; Code[20])
        {
            ...
            begin
                ...
                if not IsHandled then begin
                    ...
                    if not IsHandled then
                        // HS Immo probleme  VATPostingSetup.Get("VAT Bus. Posting Group", "VAT Prod. Posting Group");
                    ...
                    ShouldUpdateUnitCost := Purchr."Prices Including VAT" and (Rec.Type in [Rec.Type::Item, Rec.Type::Resource]);
        ...
        field(94; "Transférer"; Boolean)
        {
            // AutoFormatType = 1;
            Caption = 'Transférer';
            trigger OnValidate()
            begin
                if rec."N° Ordres de transfert" <> '' then
                    Error('Ligne déjà transférée');

            end;

        }
        field(96; "N° Ordres de transfert"; Code[30])
        {
            // AutoFormatType = 1;
            // Caption = 'Transférer';
...
#pragma warning restore
        ...
        field(97; "Blanket Order No."; Code[20])
        {
            ...
            TableRelation = "Purchase Request"."No." where("Document Type" = const("Blanket Order"));
        ...
        field(98; "Blanket Order Line No."; Integer)
        {
            ...
            TableRelation = "Purchase request line"."Line No." where("Document Type" = const("Blanket Order"),
                    ...
                    case "IC Partner Ref. Type" of
                        ...
                        "IC Partner Ref. Type"::"Vendor Item No.":
                            begin
                                ...
                                ItemVendorCatalog.SetRange("Vendor No.", Purchr."Buy-from Vendor No.");
        ...
        field(130; "IC Partner Code"; Code[20])
        {
            ...
            begin
                if "IC Partner Code" <> '' then begin
                    TestField(Type, Type::"G/L Account");
                    GetPurchr();
                    Purchr.TestField("Buy-from IC Partner Code", '');
                    Purchr.TestField("Pay-to IC Partner Code", '');
                    ...
                    case "IC Partner Ref. Type" of
                        "IC Partner Ref. Type"::"Cross Reference":
                            begin
                                ...
                                ItemReference.SetFilter("Reference Type No.", '%1|%2', Purchr."Buy-from Vendor No.", '');
        ...
        field(85001; "Job Task No."; Code[20])
        {
        ...
        field(85002; "Job Planning Line No."; Integer)
        {
            AccessByPermission = TableData Job = R;
            BlankZero = true;
        ...
        field(1700; "Deferral Code"; Code[10])
        {
            ...
            begin
                GetPurchr();
                DeferralPostDate := GetDeferralPostDate(Purchr);
                ...
                DeferralUtilities.DeferralCodeOnValidate(
                  ...
                  Description, Purchr."Currency Code");

                if "Document Type" = "Document Type"::"Return Order" then
                    "Returns Deferral Start Date" :=
                      DeferralUtilities.GetDeferralStartDate(
                          Enum::"Deferral Document Type"::Purchase.AsInteger(),
                          "Document Type".AsInteger(), "Document No.", "Line No.", "Deferral Code", Purchr."Posting Date");
            end;
        }
        ...
        field(2677; "Alloc. Acc. Modified by User"; Boolean)
        {
            ...
            FieldClass = FlowField;
            CalcFormula = exist(Microsoft.Finance.AllocationAccount."Alloc. Acc. Manual Override" where("Parent System Id" = field(SystemId), "Parent Table Id" = const(Database::"Purchase request line")));
        }
...
#pragma warning restore
        ...
        field(5707; "Cross-Reference Type"; Enum "Dys Cross-Reference Type")
        {
        ...
        field(5725; "Item Reference No."; Code[50])
        {
            ...
            begin
                GetPurchr();
                //ItemReferenceMgt.PurchaseReferenceNoLookUp(Rec, Purchr);
            end;
            ...
            begin
                GetPurchr();
                "Buy-from Vendor No." := Purchr."Buy-from Vendor No.";
                // ItemReferenceMgt.ValidatePurchaseReferenceNo(Rec, Purchr, ItemReference, true, CurrFieldNo);
            end;
        }
...
#pragma warning restore
                ...
                if Purchr."Currency Code" <> '' then
                    "Return Shpd. Not Invd. (LCY)" :=
                      Round(
                        CurrExchRate.ExchangeAmtFCYToLCY(
                          GetDate(), "Currency Code",
                          "Return Shpd. Not Invd.", Purchr."Currency Factor"),
                        Currency2."Amount Rounding Precision")
                else
                    "Return Shpd. Not Invd. (LCY)" :=
        ...
        field(6609; Subtype; Enum "Dys Subtype")
        {
            Caption = 'Subtype';
        ...
        {
            CalcFormula = count("Purchase request line" where("Document Type" = field("Document Type"),
                                                       "Document No." = field("Document No."),
        ...
        field(8509; "Over-Receipt Quantity"; Decimal)
        {
            ...
            var
                ...
                PurchaseR: Record "Purchase Request";
            ...
            begin
                ...
                if xRec."Over-Receipt Quantity" = "Over-Receipt Quantity" then
                    exit;
                PurchaseR.Get(Rec."Document Type", Rec."Document No.");
                PurchaseR.TestField("Document Type", Purchr."Document Type"::Order);
                PurchaseR.TestField(Status, Purchr.Status::Released);
                TestField(Type, Type::Item);
                TestField("No.");
                ...
                if "Over-Receipt Quantity" = 0 then begin
                    "Over-Receipt Approval Status" := "Over-Receipt Approval Status"::" ";
                    OverReceiptMgt.RecallOverReceiptNotification(PurchaseR.RecordId());
                end else
                    OverReceiptMgt.ShowOverReceiptNotificationFromLine(PurchaseR."No.");
            end;
        }
        ...
        field(59001; "Filtre Article"; Code[20])
        {
            Caption = 'Item filter';
            ...
            begin
                // >> HJ DST 02-02-2013
                "Filtre Article" := GetItemFilter("Filtre Article");
        ...
        field(50006; "Location inventory In Progress"; Decimal)
        {
            Caption = 'Location inventory In Progress';
        ...
        field(59007; "Type Divers"; Enum "Dys Type Divers")
        {

            //OptionMembers = " ",Divers,Transport,"Sous Traitance";
        }
        field(59008; Materiel; Decimal)
        {
            DecimalPlaces = 3 : 3;
            Caption = 'Materiel';
        }
        field(50009; "Labor Material"; Decimal)
        {
            DecimalPlaces = 3 : 3;
            Caption = 'Labor Material';

        }
        field(50010; "Consumption Detail"; Decimal)
        {
            DecimalPlaces = 3 : 3;
            Caption = 'Consumption Detail';
        }
        field(50400; "Transportation Detail"; Decimal)
        {
            DecimalPlaces = 3 : 3;
        ...
        {
            DecimalPlaces = 3 : 3;
            Caption = 'Subcontracting Detail';
        }
        field(50013; "Various Detail"; Decimal)
        {
            DecimalPlaces = 3 : 3;
            Caption = 'Various Detail';
        }
        field(50014; "Detail Supply"; Decimal)
        {
            DecimalPlaces = 3 : 3;
            Caption = 'Detail Supply';

        }
        field(50015; "Labour Materiel Detail"; Decimal)
        {
            DecimalPlaces = 3 : 3;
            Caption = 'Labour Materiel Detail';
        }
        field(59016; "Materiel Detail"; Decimal)
        {
            DecimalPlaces = 3 : 3;
            Caption = 'Materiel Detail';
        }
        field(59017; "Supply And Various Detail"; Decimal)
        {
            DecimalPlaces = 3 : 3;
            Caption = 'Supply And Various Detail';
        }
        field(59018; "Small Entre Detail Lubricants"; Decimal)
        {
            DecimalPlaces = 3 : 3;
            Caption = 'Small Entre Detail Lubricants';
        }
        field(59019; "On Model"; Text[100])
        {
            Caption = 'On Model';


        }
        field(59020; Statut; Enum "Dys PR Line")
        {
            Caption = 'Approval';
            ValuesAllowed = 0, 5, 6, 7;
        ...
        field(59021; "Apply Fodec"; Boolean)
        {
            Caption = 'Apply Fodec';
        }
        field(5022; "Item Charges related"; Code[20])
        {
            TableRelation = Item;
            Caption = 'Item Charges related';
        }
        field(50023; "Posting date"; Date)
        {
            Caption = 'Posting date';

        }
        field(59024; "User ID"; Code[50])
        {
            Caption = 'User ID';
        }
        field(59025; "Price Code"; Code[5])
        {
            Caption = 'Price Code';
        }
        field(59026; Origin; Text[20])
        {
            Caption = 'Origin';
            //  TableRelation = "Chargement - Dechargement";
        }
        field(59027; Destination; Text[20])
        {
            Caption = 'Destination';
            //  TableRelation = "Chargement - Dechargement";
        }
        field(59028; Time; Time)
        {
            Caption = 'Time';
            Description = 'RB SORO 19/09/2017';
        }
        field(59029; Vehicule; Code[20])
        {
            Description = 'RB SORO 19/09/2017';
        ...
        field(59030; Driver; Code[20])
        {
            Caption = 'Driver';
            TableRelation = "Shipping Agent";
        }
        field(59032; Consumption; Decimal)
        {
            DecimalPlaces = 3 : 3;
            Caption = 'Consumption';
        }
        field(50033; Transportation; Decimal)
        {
            DecimalPlaces = 3 : 3;
            Caption = 'Transportation';
        }
        field(50034; "sub-contracting"; Decimal)
        {
            DecimalPlaces = 3 : 3;
            Caption = 'sub-contracting';
        }
        field(50035; various; Decimal)
        {
            DecimalPlaces = 3 : 3;
            Caption = 'various';
        }
        field(50036; "Supply And Miscellaneous"; Decimal)
        {
            DecimalPlaces = 3 : 3;
            Caption = 'Supply And Miscellaneous';
        }
        field(50037; "Lubricants Small Maintenance"; Decimal)
        {
            DecimalPlaces = 3 : 3;
            Caption = 'Lubricants Small Maintenance';
        }
        field(50038; "Detail Labour"; Decimal)
        {
            Caption = 'Detail Labour';
        }
        ...
        field(50040; Supplies; Decimal)
        {
            Caption = 'Supplies';
        }
        field(50041; "Price No."; Code[20])
        {
            Caption = 'Price No.';
        }
        field(50042; Sort; Integer)
        {
            Caption = 'Sort';
        }
        ...
        field(50045; "Type Operation"; Enum "Dys PR Line Operation")
        {
            Caption = 'type operation';
            // OptionMembers = " ",D,M;
        }
        field(50046; "Coeficient Report"; Decimal)
        {
            Caption = 'Coeficient Report';
        }
        field(50047; "Total inventory"; Decimal)
        {
            CalcFormula = sum("Item Ledger Entry".Quantity where("Item No." = field("No.")));
        ...
        field(50048; "Quantity ordered Not Delivered"; Decimal)
        {
            CalcFormula = sum("Purchase request line"."Outstanding Quantity" where("No." = field("No."),
                                                                            "Job No." = field("Job No.")));
            Caption = 'Quantity ordered Not Delivered';
            Editable = false;
            FieldClass = FlowField;
        }
        ...
        field(60004; "amendment 1"; Decimal)
        {
            DecimalPlaces = 0 : 3;
            Caption = 'amendment 1';
            trigger OnValidate()
            begin
                Validate(Quantity, "amendment 1" + "amendment 2" + "amendment 3" + "amendment 4" + "Quantité Intiale Marché");
            end;
        }
        field(60005; "amendment 2"; Decimal)
        {
            DecimalPlaces = 0 : 3;
            Caption = 'amendment 2';
            trigger OnValidate()
        ...
        field(60006; "amendment 3"; Decimal)
        {
            DecimalPlaces = 0 : 3;
            Caption = 'amendment 3';
            trigger OnValidate()
        ...
        field(60007; "amendment 4"; Decimal)
        {
            DecimalPlaces = 0 : 3;
            Caption = 'amendment 4';
            trigger OnValidate()
        ...
        field(60010; Avoir; Decimal)
        {
        }
        field(60011; Separator; Integer)
        {
            Caption = 'Separator';
        }
        field(60012; "Lot No."; Code[20])
        {
            Caption = 'Lot No.';
        }
        field(60040; "Serial No."; Code[20])
        {
            Caption = 'Serial No.';

        }
        field(60013; "Expiration Date"; Date)
        {
            Caption = 'Expiration Date';
        }
        field(60014; "Subscription Starting Date"; Date)
        {
            Caption = 'Subscription Starting Date';


        }
        field(60015; "Subscription End Date"; Date)
        {
            Caption = 'Subscription End Date';


        }
        field(60016; "Subscription Posting Date"; Date)
        {
            Caption = 'Subscription Posting Date';
            Editable = false;
        }
        field(60017; "Contract Base Unit Price"; Decimal)
        {
            Caption = 'Contract Base Unit Price';
        }
        field(60018; "Contract Budget Date"; Date)
        {
            Caption = 'Contract Budget Date';
            Editable = false;
        }
        field(60019; "Review Option"; Enum "Dys Review option")
        {
            Caption = 'Review Option';
            // OptionCaption = ' ,Formula';
            // OptionMembers = " ",Formula;
        }
        field(60020; "Scheduler Line No."; Integer)
        {
            Caption = 'Scheduler Line No.';
            Editable = false;
        }
        field(60021; "Previous Prod. Completion %"; Decimal)
        {
            Caption = 'Previous Prod. Completion %';
        }
        field(60022; "Outstanding Amt Excl VAT(LCY)"; Decimal)
        {
        ...
        field(60023; "Order Type"; Enum "Dys order type")
        {
            Caption = 'Order Type';
            Editable = false;
        ...
        field(60024; "Completely Invoiced"; Boolean)
        {
            Caption = 'Completely Invoiced';
            Editable = false;
        }
        field(60025; "Imported Line"; Boolean)
        {
            Caption = 'Imported Line';
        }
        field(60026; "Internal Description"; Text[100])
        {
            Caption = 'Internal Description';


        }
        field(60027; "Excel Line No."; Integer)
        {
            Caption = 'Excel Line No.';
        }
        field(60028; "Unit-Amount Rounding Precision"; Decimal)
        {
            BlankZero = true;
        ...
        field(60029; "Cross-Ref. Line No."; Integer)
        {
            Caption = 'Cross-Ref. Line No.';
        }
        field(60030; Marker; Code[20])
        {
            Caption = 'Marker';


        }
        field(60031; "Order Date"; Date)
        {
            Caption = 'Order Date';
        }
        field(60032; "Purchasing Document Type"; Enum "Dys Purchasing Document Type")
        {
            Caption = 'Purchasing Document Type';
            // OptionCaption = 'Quote,Order,Invoice,Credit Memo,Blanket Order,Return Order';
            // OptionMembers = Quote,"Order",Invoice,"Credit Memo","Blanket Order","Return Order";
        }
        field(60033; "Purchasing Order No."; Code[20])
        {
            Caption = 'Purchasing Order No.';
        }
        field(60034; "Purchasing Order Line No."; Integer)
        {
            Caption = 'Purchasing Order Line No.';
            //This property is currently not supported
            //TestTableRelation = false;
        }
        field(60035; "Purch. Order Qty (Base)"; Decimal)
        {
            Caption = 'Purch. Order Qty (Base)';
        }
        field(60036; "Purch. Order Receipt Date"; Date)
        {
            Caption = 'Purch. Order Receipt Date';
        }
        field(60037; "Purch. Order Rcpt. Qty (Base)"; Decimal)
        {
            Caption = 'Purch. Order Rcpt. Qty (Base)';
        }
        field(60038; Option; Boolean)
        {
            Caption = 'Option';

        }
        field(63951; "Distribution Basis"; Enum "Dys Distribution Basis")
        {
            BlankZero = true;
        ...
        field(63952; "Distribution Method"; Enum "Dys Distribution Method")
        {
        ...
        field(63953; "Job Cost Assignment"; Code[10])
        {
            Caption = 'Job Cost Marked';

            trigger OnValidate()
            begin
                TestField("Distribution Method", "Distribution Method"::Selection);
            end;
        }
        field(63954; "Calculation method"; Enum "Dys Calculation method")
        {
            Caption = 'Calculation method';
            // OptionCaption = 'Amount,% on Base,% on Result';
            // OptionMembers = Amount,"% on Base","% on Result";
        }
        field(63955; "Rate Amount"; Decimal)
        {
        ...
        field(63956; "Gen. Prod. Posting Prorata"; Code[20])
        {
            Caption = 'Gen. Prod. Posting Prorata';
            TableRelation = if ("Distribution Basis" = filter(<> " ")) "Gen. Product Posting Group";
            ValidateTableRelation = false;
            ...
            begin
                if ("Distribution Method" <> "Distribution method"::" ") and ("Distribution Basis" = "Distribution Basis"::" ") then
                    Error(lTextNoAssgnt, FieldCaption("Distribution Basis"));
                if (CurrFieldNo <> 0) and (Type = Type::" ") then
                    Error(lTextError, FieldCaption("Distribution Basis"));
            end;
        }
        field(63983; "Amount Excl. VAT (LCY)"; Decimal)
        {
            Caption = 'Amount Excl. VAT (LCY)';

        }
        field(63984; "WIP Amount Posted"; Decimal)
        {
            Caption = 'WIP Amount Posted';
        }
        field(63985; "Global Disc. Amount"; Decimal)
        {
            Caption = 'Global Disc. Amount';
            DecimalPlaces = 2 : 2;

        }
        field(63986; "Vendor Order Address Code"; Code[10])
        {
            Caption = 'Vendor Order Address Code';
            TableRelation = "Order Address".Code where("Vendor No." = field("Vendor No."));
        }
        field(63991; "Rider Rank"; Integer)
        {
            Caption = 'Rider Rank';
        }
        field(63992; "Quote No."; Code[20])
        {
            Caption = 'Quote No.';
        }
        field(63996; "Line Type Filter"; Enum "Dys Line Type Filter")
        {
        ...
        field(63997; "Order No."; Code[20])
        {
            Editable = false;
        }
        field(64048; "Number of Resources"; Decimal)
        {
            BlankZero = true;
            ...
            begin
                ...
                else if "Rate Quantity" <> 0 then
                    Validate("Rate Quantity")
                else
                    Validate("Quantity Fixed");
            end;
        }
        field(64049; "Rate Quantity"; Decimal)
        {
            BlankZero = true;
        ...
        field(64050; "Line Type"; Enum "Dys Line Type")
        {
            Caption = 'Line Type';
            // OptionCaption = ' ,Totaling,Item,Person,Machine,Structure,G/L Account,Charge (Item),Doc. Footer,Fixed Asset';
            // OptionMembers = " ",Totaling,Item,Person,Machine,Structure,"G/L Account","Charge (Item)",Other,"Fixed Asset";


        }
        field(64052; "Structure Line No."; Integer)
        {
            Caption = 'Structure Line No.';
        }
        field(64053; "Quantity per"; Decimal)
        {
        ...
        field(64054; "Found Price"; Decimal)
        {
            Caption = 'Found Price';
        }
        field(64055; "Quantity Fixed"; Decimal)
        {
            BlankZero = true;
        ...
        field(64056; "Presentation Code"; Text[20])
        {
            Caption = 'Presentation Code';

        }
        field(64057; Level; Integer)
        {
            Caption = 'Level';
        }
        field(64058; "Vendor No."; Code[20])
        {
            TableRelation = Vendor;
            Caption = 'Vendor No.';

        }
        field(64059; "Direct Cost"; Decimal)
        {
            BlankZero = true;
            Caption = 'Direct Cost';
            Editable = false;
        }
        field(64060; "Supply Order No."; Code[20])
        {
            Caption = 'Supply Order No.';
            TableRelation = "Purchase Request"."No." where("Document Type" = const(Order),
                                                        "Order Type" = const("Supply Order"),
                                                        "Job No." = field("Job No."));


        }
        field(64061; "Supply Order Line No."; Integer)
        {
        ...
        field(64062; "Theoretical Profit Amount(LCY)"; Decimal)
        {
            Caption = 'Theoretical Profit Amount (LCY)';
            Editable = false;
        }
        field(64063; "Overhead Amount (LCY)"; Decimal)
        {
            BlankZero = true;
            Caption = 'Overhead Amount (LCY)';
            Editable = false;
        }
        field(64064; "Fixed Price"; Boolean)
        {
            Caption = 'Sales Price Fixed';


        }
        field(64065; "Optionnal Quantity"; Decimal)
        {
            BlankZero = true;
            Caption = 'Option Quantity';
            DecimalPlaces = 0 : 5;
        }
        field(64066; "Value 1"; Decimal)
        {

            Caption = 'Value 1';

        }
        field(64067; "Value 2"; Decimal)
        {

            Caption = 'Value 2';

        }
        field(64068; "Value 3"; Decimal)
        {

            Caption = 'Value 3';

        }
        field(64069; "Value 4"; Decimal)
        {


            Caption = 'Value 4';
        }
        field(64070; "Value 5"; Decimal)
        {

            Caption = 'Value 5';

        }
        field(64071; "Value 6"; Decimal)
        {


            Caption = 'Value 6';
        }
        field(64072; "Value 7"; Decimal)
        {

            Caption = 'Value 7';
        }
        field(64073; "Value 8"; Decimal)
        {


            Caption = 'Value 8';
        }
        field(64074; "Value 9"; Decimal)
        {

            Caption = 'Value 9';

        }
        field(64075; "Value 10"; Decimal)
        {

            Caption = 'Value 10';

        }
        field(64076; Comment; Boolean)
        {
            Caption = 'Comment';
        }
        field(64077; "Job Costs (LCY)"; Decimal)
        {
            BlankZero = true;
            Caption = 'Job Costs (LCY)';
            Editable = false;
        }
        field(64078; "Amount 1"; Decimal)
        {
            Caption = 'Amount 1';
        }
        field(64079; "Amount 2"; Decimal)
        {
            Caption = 'Amount 2';
        }
        field(64080; "Amount 3"; Decimal)
        {
            Caption = 'Amount 3';
        }
        field(64081; "Amount 4"; Decimal)
        {
            Caption = 'Amount 4';
        }
        field(64082; "Amount 5"; Decimal)
        {
            Caption = 'Amount 5';
        }
        field(64083; "Amount 6"; Decimal)
        {
            Caption = 'Amount 6';
        }
        field(64084; "Amount 7"; Decimal)
        {
            Caption = 'Amount 7';
        }
        field(64085; "Amount 8"; Decimal)
        {
            Caption = 'Amount 8';
        }
        field(64086; "Amount 9"; Decimal)
        {
            Caption = 'Amount 8';
        }
        field(64087; "Amount 10"; Decimal)
        {
            Caption = 'Amount 10';
        }
        field(64088; "Machine Quantity"; Decimal)
        {
            Caption = 'Machine Quantity';
        }
        field(64089; "Person Quantity"; Decimal)
        {
            Caption = 'Person Quantity';


        }
        field(64090; "Print Option Line"; Enum "Dys Print Option Line")
        {
            Caption = 'Print Option Line';
            // OptionCaption = ' ,Page Skip';
            // OptionMembers = " ","Page Skip";
        }
        field(64091; "Total Cost LCY by Line Type"; Decimal)
        {
            Caption = 'Total Cost LCY by Line Type';
        }
        field(64092; "Vendor Ledger Entry No."; Integer)
        {
            Caption = 'Vendor Ledger Entry No.';
        }
        field(64093; "Print Structure Line"; Boolean)
        {
            Caption = 'Print Structure Line';
        }
        field(64094; Rate; Decimal)
        {
            BlankZero = true;
            Caption = 'Rate';
            DecimalPlaces = 0 : 5;
        ...
        field(64095; Dummy; Text[30])
        {
            Caption = 'Dummy';
        }
        field(64096; "Need Qty"; Decimal)
        {
            Caption = 'Need Qty';
        }
        field(64098; Duration; Decimal)
        {
            BlankZero = true;
            Caption = 'Duration';
            DecimalPlaces = 0 : 5;
        ...
        field(64099; "Job Costs Margin Included"; Decimal)
        {
            BlankZero = true;
            Caption = 'Job Costs Margin Included';
            Editable = false;
        }
        field(64101; "Field Filter"; Integer)
        {
            Caption = 'Field Filter';
            FieldClass = FlowFilter;
        }
        field(64104; "Need Unit of Measure Code"; Code[10])
        {
            CalcFormula = lookup(Item."Base Unit of Measure" where("No." = field("No.")));
            Caption = 'Need Unit of Measure Code';
            FieldClass = FlowField;
        }
        field(64106; "Item Type"; Enum "Dys Item Type")
        {
            Caption = 'Item Type';
            // OptionCaption = ' ,Specific,Generic';
            // OptionMembers = " ",Specific,Generic;
        }
        field(64131; "Date Filter"; Date)
        {
            Caption = 'Date Filter';
            FieldClass = FlowFilter;
        }
        field(64132; "Gen. Prod Posting Group Filter"; Code[10])
        {
            Caption = 'Gen. Prod Posting Group Filter';
        }
        field(64134; Subcontracting; Enum "Dys Subcontracting")
        {
        ...
        field(64135; Disable; Boolean)
        {
            Caption = 'Disable';


        }
        field(64136; "Disable Quantity"; Decimal)
        {
            Caption = 'Disable Quantity';
            DecimalPlaces = 0 : 5;
            Editable = false;
        }
        field(64137; "Resource Group No."; Code[20])
        {
            Caption = 'Resource Group No.';
            TableRelation = "Resource Group";
        }
        field(64138; "Advanced Person Budget (Qty)"; Decimal)
        {
            Caption = 'Advanced Person Budget (Qty)';
        }
        field(64139; "Non Valued Code"; Code[10])
        {
            Caption = 'Non-Valued Code';

        }
        field(64140; "Reason Refusal"; Text[250])
        {
            Caption = 'Reason Refusal';
        }
        field(64141; "Associated Purchase Order"; Code[20])
        {
            Editable = false;
...
#pragma warning RESTORE AS0038
    ...
    var
        ...
        Purchr: Record "Purchase Request";
    ...
    begin
        ...
        // OnAfterInitOutstandingAmount(Rec, xRec, Purchr, Currency);
    end;
    ...
    begin
        ...
        CalcInvDiscToInvoice();
        if Purchr."Document Type" <> Purchr."Document Type"::Invoice then
            CalcPrepaymentToDeduct();

        // OnAfterInitQtyToInvoice(Rec, CurrFieldNo);
    end;

    local procedure InitOutstandingAndQtyToShipReceive(var TempPurchReqLine: Record "Purchase request Line" temporary)
    var
        IsHandled: Boolean;
    begin
        IsHandled := false;
    ...
    procedure InitHeaderDefaults(Purchr: Record "Purchase Header"; var TempPurchLine: Record "Purchase Line" temporary)
    var
        IsHandled: Boolean;
    begin
        CheckBuyFromVendorNo(Purchr);

        "Buy-from Vendor No." := Purchr."Buy-from Vendor No.";
        "Currency Code" := Purchr."Currency Code";
        "Expected Receipt Date" := Purchr."Expected Receipt Date";
        "Shortcut Dimension 1 Code" := Purchr."Shortcut Dimension 1 Code";
        "Shortcut Dimension 2 Code" := Purchr."Shortcut Dimension 2 Code";
        "Dimension Set ID" := Purchr."Dimension Set ID";
        "Location Code" := Purchr."Location Code";
        "Transaction Type" := Purchr."Transaction Type";
        "Transport Method" := Purchr."Transport Method";
        "Pay-to Vendor No." := Purchr."Pay-to Vendor No.";
        "Price Calculation Method" := Purchr."Price Calculation Method";
        "Gen. Bus. Posting Group" := Purchr."Gen. Bus. Posting Group";
        IsHandled := false;
        //   OnInitHeaderDefaultsOnBeforeSetVATBusPostingGroup(Rec, IsHandled);
        if not IsHandled then
            "VAT Bus. Posting Group" := Purchr."VAT Bus. Posting Group";
        "Entry Point" := Purchr."Entry Point";
        Area := Purchr.Area;
        "Transaction Specification" := Purchr."Transaction Specification";
        "Tax Area Code" := Purchr."Tax Area Code";
        "Tax Liable" := Purchr."Tax Liable";
        if not "System-Created Entry" and ("Document Type" = "Document Type"::Order) and HasTypeToFillMandatoryFields() or
           IsServiceCharge()
        then
            "Prepayment %" := Purchr."Prepayment %";
        "Prepayment Tax Area Code" := Purchr."Tax Area Code";
        "Prepayment Tax Liable" := Purchr."Tax Liable";
        "Responsibility Center" := Purchr."Responsibility Center";
        "Requested Receipt Date" := Purchr."Requested Receipt Date";
        "Promised Receipt Date" := Purchr."Promised Receipt Date";
        "Inbound Whse. Handling Time" := Purchr."Inbound Whse. Handling Time";
        "Order Date" := Purchr."Order Date";

        // OnAfterInitHeaderDefaults(Rec, Purchr, TempPurchLine);
    end;
    ...
    local procedure CopyFromGLAccount(var TempPurchaseReqLine: Record "Purchase request Line" temporary)
    var
        IsHandled: Boolean;
    begin
        IsHandled := false;
        ...
        //OnAfterAssignGLAccountValues(Rec, GLAcc, Purchr, xRec, TempPurchaseLine);
    end;
    ...
    begin
        ...
        "Allow Item Charge Assignment" := true;
        //  PrepaymentMgt.SetPurchPrepaymentPct(Rec, Purchr."Posting Date");
        if IsInventoriableItem() then
            PostingSetupMgt.CheckInvtPostingSetupInventoryAccount("Location Code", "Posting Group");
        ...
        InitDeferralCode();
        //   OnAfterAssignItemValues(Rec, Item, CurrFieldNo, Purchr);
    end;
    ...
    begin
        ...
        "Allow Invoice Disc." := false;
        "Allow Item Charge Assignment" := false;
        // OnAfterAssignFixedAssetValues(Rec, FixedAsset, Purchr);
    end;
    ...
    begin
        ...
        "Indirect Cost %" := 0;
        "Overhead Rate" := 0;
        //    OnAfterAssignItemChargeValues(Rec, ItemCharge, Purchr);
    end;
    ...
    procedure SetPurchr(NewPr: Record "Purchase Request")
    begin
        Purchr := NewPr;
        ...
        if Purchr."Currency Code" = '' then
            ...
            Purchr.TestField("Currency Factor");
            Currency.Get(Purchr."Currency Code");
            Currency.TestField("Amount Rounding Precision");
        end;
    end;

    procedure GetPurchr(): Record "Purchase Request"
    begin
        GetPurchr(Purchr, Currency);
        exit(Purchr);
    end;

    procedure GetPurchr(var OutPurchR: Record "Purchase Request"; var OutCurrency: Record Currency)
    var
        IsHandled: Boolean;
    begin
        IsHandled := false;
        // OnBeforeGetPurchr(Rec, Purchr, IsHandled, Currency);
        if IsHandled then
            exit;

        TestField("Document No.");
        if ("Document Type" <> Purchr."Document Type") or ("Document No." <> Purchr."No.") then
            if Purchr.Get(Rec."Document No.") then
                if Purchr."Currency Code" = '' then
                    Currency.InitRoundingPrecision()
                else begin
                    Purchr.TestField("Currency Factor");
        ...
        //  OnAfterGetPurchr(Rec, Purchr, Currency);
        OutPurchR := Purchr;
    ...
    begin
        if "Document No." = '' then
            exit(0);
        GetPurchr();
        if not Purchr."Prices Including VAT" then
            exit("Line Amount");
    ...
    begin
        if "Document No." = '' then
            exit(0);
        GetPurchr();
        if Purchr."Prices Including VAT" then
            exit("Line Amount");
        ...
        case Type of
            ...
            Type::Resource:
                begin
                    GetPurchr();
                    IsHandled := false;
                    //  OnUpdateDirectUnitCostOnBeforeFindPrice(Purchr, Rec, CalledByFieldNo, CurrFieldNo, IsHandled, xRec);
                    if not IsHandled then
                        if not BlanketOrderIsRelated(BlanketOrderPurchaseLine) then begin
                            GetPriceCalculationHandler(Purchr, PriceCalculation);
                            ...
                            //  OnUpdateDirectUnitCostByFieldOnAfterSetBlanketOrderPriceFields(Purchr, BlanketOrderPurchaseLine, Rec, CalledByFieldNo, CurrFieldNo);
                        end;
    ...
    procedure GetPriceCalculationHandler(PurchaseR: Record "Purchase Request"; var PriceCalculation: Interface "Price Calculation")
    var
        PriceCalculationMgt: codeunit "Price Calculation Mgt.";
        LineWithPrice: Interface "Line With Price";
        PriceType: Enum "Price Type";
    begin
        if (PurchaseR."No." = '') and ("Document No." <> '') then
            PurchaseR.Get(Rec."Document Type", Rec."Document No.");
        GetLineWithPrice(LineWithPrice);
        LineWithPrice.SetLine(PriceType::Purchase, PurchaseR, Rec);
    ...
    begin
        ...
        //  OnUpdateUnitCostOnBeforeUpdateUnitCostLCY(Rec, xRec, Purchr, CurrFieldNo, Item, SKU, Currency, GLSetup);
        ...
        if Purchr."Currency Code" <> '' then begin
            ...
            "Unit Cost (LCY)" :=
              CurrExchRate.ExchangeAmtFCYToLCY(
                GetDate(), "Currency Code",
                "Unit Cost", Purchr."Currency Factor");
        end else
        ...
        //   OnAfterUpdateUnitCost(Rec, xRec, Purchr, Item, SKU, Currency, GLSetup);
                ...
                case "VAT Calculation Type" of
                    ...
                    "VAT Calculation Type"::"Reverse Charge VAT":
                        begin
                            ...
                            "VAT Base Amount" :=
                              Round(
                                Amount * (1 - Purchr."VAT Base Discount %" / 100),
                                Currency."Amount Rounding Precision");
                            "Amount Including VAT" :=
                              TotalLineAmount + "Line Amount" -
                              Round(
                                (TotalAmount + Amount) * (Purchr."VAT Base Discount %" / 100) * "VAT %" / 100,
                                Currency."Amount Rounding Precision", Currency.VATRoundingDirection()) -
                              TotalAmountInclVAT - TotalInvDiscAmount - "Inv. Discount Amount";
                            //    NonDeductibleVAT.Update(Rec, Currency);
                            //OnUpdateVATAmountsOnAfterCalcNormalVATAmountsForPricesIncludingVAT(Rec, Purchr, Currency, TotalAmount, TotalAmountInclVAT, PurchLine2);
                        end;
                    "VAT Calculation Type"::"Full VAT":
                        begin
                            Amount := 0;
                    ...
                    "VAT Calculation Type"::"Reverse Charge VAT":
                        begin
                            ...
                            "Amount Including VAT" :=
                              TotalAmount + Amount +
                              Round(
                                (TotalAmount + Amount) * (1 - Purchr."VAT Base Discount %" / 100) * "VAT %" / 100,
                                Currency."Amount Rounding Precision", Currency.VATRoundingDirection()) -
                              TotalAmountInclVAT + TotalVATDifference;
                            //   NonDeductibleVAT.Update(Rec, Currency);
                            //  OnUpdateVATAmountsOnAfterCalcNormalVATAmountsForPricesExcludingVAT(Rec, Purchr, Currency, TotalAmount, TotalAmountInclVAT, PurchLine2);
                        end;
                    "VAT Calculation Type"::"Full VAT":
                        begin
                            Amount := 0;
    ...
    begin
        ...
        GetPurchr();
        if Purchr."Posting Date" <> 0D then
            exit(Purchr."Posting Date");
        exit(WorkDate());
    end;
    ...
    begin
        ...
        "Dimension Set ID" :=
          DimMgt.GetRecDefaultDimID(
            ...
            "Shortcut Dimension 1 Code", "Shortcut Dimension 2 Code", Purchr."Dimension Set ID", Database::Vendor);
    ...
    begin
        ...
        if ("Inv. Discount Amount" = 0) and
           ...
           (not Purchr."Prices Including VAT")
        then
    ...
    begin
        GetPurchr();
        IsHandled := false;
        ///  OnBeforeTestStatusOpen(Rec, Purchr, xRec, CurrFieldNo, IsHandled);
        if IsHandled then
            exit;
        ...
        if not "System-Created Entry" then
            if (xRec.Type <> Type) or HasTypeToFillMandatoryFields() then
                Purchr.TestField(Statut, Purchr.Statut::Open);

        // OnAfterTestStatusOpen(Rec, Purchr);
    end;
    ...
    begin
        ...
        if Type = Type::Item then begin
            ...
            if Format("Lead Time Calculation") = '' then
                "Lead Time Calculation" := Purchr."Lead Time Calculation";
    ...
    begin
        GetPurchr();
        if Purchr."Expected Receipt Date" <> 0D then
            Validate("Expected Receipt Date", Purchr."Expected Receipt Date")
        else
            Validate("Order Date", Purchr."Order Date");
    end;
    ...
    procedure UpdateVATOnLines(QtyType: Option General,Invoicing,Shipping; var Purchr: Record "Purchase Header"; var PurchLine: Record "Purchase Line"; var VATAmountLine: Record "VAT Amount Line") LineWasModified: Boolean
    var
    ...
    begin
        ...
        IsHandled := false;
        //   OnUpdateVATOnLinesOnBeforeProcessPurchLines(Rec, xRec, Purchr, VATAmountLine, TempVATAmountLineRemainder, LineWasModified, IsHandled, QtyType);
        if IsHandled then
            exit(LineWasModified);

        PurchLine.SetRange("Document Type", Purchr."Document Type");
        PurchLine.SetRange("Document No.", Purchr."No.");
        SetLoadFieldsForInvDiscoundCalculation(PurchLine);
        OnUpdateVATOnLinesOnAfterSetFilters(PurchLine, Purchr);
        PurchLine.LockTable();
        if PurchLine.FindSet() then
            repeat
                if not PurchLine.ZeroAmountLine(QtyType) then begin
                    OnUpdateVATOnLinesOnBeforeProcessPurchLine(PurchLine, Purchr, VATAmountLine, QtyType);
                    ...
                    if VATAmountLine.Modified then begin
                        ...
                        OnUpdateVATOnLinesOnBeforeCalculateAmounts(PurchLine, Purchr);
                        if QtyType = QtyType::General then begin
                            if Purchr."Prices Including VAT" then begin
                                ...
                                NewVATBaseAmount :=
                                  Round(
                                    NewAmount * (1 - Purchr."VAT Base Discount %" / 100),
                                    Currency."Amount Rounding Precision");
                            end else begin
                                if PurchLine."VAT Calculation Type" = PurchLine."VAT Calculation Type"::"Full VAT" then begin
                                    ...
                                    NewVATBaseAmount :=
                                      Round(
                                        ...
                                        Currency."Amount Rounding Precision");
                                    IsHandled := false;
                                    //   OnUpdateVATOnLinesOnBeforeCalcNotFullVATAmount(Rec, Purchr, Currency, VATAmountLine, TempVATAmountLineRemainder, NewVATBaseAmount, VATAmount, IsHandled);
                                    if not IsHandled then
                        ...
                        OnUpdateVATOnLinesOnAfterCalculateAmounts(PurchLine, Purchr);
                        ...
                        if QtyType = QtyType::General then begin
                            ...
                            OnUpdateVATOnLinesOnAfterUpdateBaseAmounts(Purchr, PurchLine, TempVATAmountLineRemainder, VATAmountLine, Currency);
                        end;
        ...
        OnAfterUpdateVATOnLines(Purchr, PurchLine, VATAmountLine, QtyType);
    end;

    procedure CalcVATAmountLines(QtyType: Option General,Invoicing,Shipping; var Purchr: Record "Purchase Header"; var PurchLine: Record "Purchase Line"; var VATAmountLine: Record "VAT Amount Line")
    var
        TempVATAmountLineRemainder: Record "VAT Amount Line" temporary;
    ...
    begin
        if IsCalcVATAmountLinesHandled(Purchr, PurchLine, VATAmountLine, QtyType) then
            exit;

        Currency.Initialize(Purchr."Currency Code");
        ...
        PurchLine.SetRange("Document No.", Purchr."No.");
        SetLoadFieldsForInvDiscoundCalculation(PurchLine);
        OnCalcVATAmountLinesOnAfterSetFilters(PurchLine, Purchr);
        if PurchLine.FindSet() then
            repeat
                if not PurchLine.ZeroAmountLine(QtyType) then begin
                    OnCalcVATAmountLinesOnBeforeProcessPurchLine(PurchLine, Purchr, VATAmountLine, QtyType);
                    if (PurchLine.Type = PurchLine.Type::"G/L Account") and not PurchLine."Prepayment Line" then
                        RoundingLineInserted := ((PurchLine."No." = PurchLine.GetVPGInvRoundAcc(Purchr)) and PurchLine."System-Created Entry") or RoundingLineInserted;
                    ...
                    case QtyType of
                        ...
                        QtyType::Invoicing:
                            begin
                                IsHandled := false;
                                OnCalcVATAmountLinesOnBeforeAssignQuantities(Purchr, PurchLine, VATAmountLine, QtyToHandle, IsHandled);
                                if not IsHandled then
                                    case true of
                                        (PurchLine."Document Type" in [PurchLine."Document Type"::Order, PurchLine."Document Type"::Invoice]) and
                                    (not Purchr.Receive) and Purchr.Invoice and (not PurchLine."Prepayment Line"):
                                        ...
                                        PurchLine.IsCreditDocType() and (not Purchr.Ship) and Purchr.Invoice:
                                ...
                                OnCalcVATAmountLinesOnQtyTypeInvoicingOnBeforeCalcAmtToHandle(PurchLine, Purchr, QtyToHandle, VATAmountLine);
                                ...
                                // OnCalcVATAmountLinesOnBeforeVATAmountLineSumLine(Rec, VATAmountLine, QtyType, PurchLine);
                                if Purchr."Invoice Discount Calculation" <> Purchr."Invoice Discount Calculation"::Amount then
                                    VATAmountLine.SumLine(
                    ...
                    OnCalcVATAmountLinesOnAfterCalcLineTotals(VATAmountLine, Purchr, PurchLine, Currency, QtyType, TotalVATAmount);
                end;
            until PurchLine.Next() = 0;
        PurchLine.SetLoadFields();
        ...
        VATAmountLine.UpdateLines(
          TotalVATAmount, Currency, Purchr."Currency Factor", Purchr."Prices Including VAT",
          Purchr."VAT Base Discount %", Purchr."Tax Area Code", Purchr."Tax Liable", Purchr."Posting Date");
        ...
        OnAfterCalcVATAmountLines(Purchr, PurchLine, VATAmountLine, QtyType);
    end;
    ...
    begin
        ...
        GetPurchr();
        //    OnAfterUpdateWithWarehouseReceive(Purchr, Rec);
    ...
    begin
        ...
        exit(
          CurrExchRate.ExchangeAmtLCYToFCY(
            GetDate(), "Currency Code", "Overhead Rate" * QtyPerUOM, Purchr."Currency Factor"));
    end;
    ...
    begin
        ...
        GetPurchr();
        if ItemTranslation.Get("No.", "Variant Code", Purchr."Language Code") then begin
            Description := ItemTranslation.Description;
            "Description 2" := ItemTranslation."Description 2";
            //  OnAfterGetItemTranslation(Rec, Purchr, ItemTranslation);
        end;
    end;
    ...
    begin
        ...
        /*HS Immo PROBLEME     if not (Type in [Type::Item, Type::"G/L Account"]) then
    ...
    begin
        ...
        TempJobJnlLine.Validate("Posting Date", Purchr."Posting Date");
    ...
    begin
        IsHandled := false;
        //    OnBeforeUpdatePrepmtAmounts(Rec, Purchr, IsHandled);
        if IsHandled then
            exit;
        ...
        GetPurchr();
        Purchr.TestField("Prices Including VAT", PurchOrderHeader."Prices Including VAT");
        if Purchr."Prices Including VAT" then begin
    ...
    begin
        ...
        if "Unit of Measure Code" = '' then
            ...
            GetPurchr();
            if Purchr."Language Code" <> '' then begin
                UnitOfMeasureTranslation.SetRange(Code, "Unit of Measure Code");
                UnitOfMeasureTranslation.SetRange("Language Code", Purchr."Language Code");
    ...
    procedure GetVPGInvRoundAcc(var Purchr: Record "Purchase Header") AccountNo: Code[20]
    var
    ...
    begin
        IsHandled := false;
        OnBeforeGetVPGInvRoundAcc(Purchr, Vendor, AccountNo, IsHandled);
        if IsHandled then
            exit(AccountNo);

        GetPurchSetup();
        if PurchSetup."Invoice Rounding" then
            if Vendor.Get(Purchr."Pay-to Vendor No.") then
    ...
    begin
        ...
        GetPurchr();
        VendorPostingGroup.Get(Purchr."Vendor Posting Group");
    ...
    begin
        IsHandled := false;
        //  OnBeforeInitType(Rec, xRec, Purchr, IsHandled);
        if IsHandled then
            exit;

        if "Document No." <> '' then begin
            if not Purchr.Get("Document Type", "Document No.") then
                exit;
            if (Purchr.Status = Purchr.Status::Released) and
        ...
        // OnAfterInitType(rec, xRec, Purchr);
    end;
    ...
    begin
        ...
        if "IC Partner Code" = '' then begin
            GetPurchr();
            exit(Purchr."Journal Templ. Name");
        end;
    ...
    begin
        IsHandled := false;
        //  OnBeforeUpdateICPartner(Rec, GLAcc, Purchr, IsHandled);
        if not IsHandled then begin
            if Purchr."Send IC Document" and
               (Purchr."IC Direction" = Purchr."IC Direction"::Outgoing)
            then
                case Type of
                    ...
                    Type::Item:
                        begin
                            ICPartner.Get(Purchr."Buy-from IC Partner Code");
        ...
        //   OnAfterUpdateICPartner(Rec, Purchr);
    end;
    ...
    begin
        ...
        // OnAfterCalcTotalAmtToAssign(Rec, Purchr, Currency, TotalQtyToAssign, TotalAmtToAssign);
    end;
    ...
    local procedure GetDeferralPostDate(PurchaseR: Record "Purchase Request") DeferralPostDate: Date
    begin
        DeferralPostDate := PurchaseR."Posting Date";
    ...
    begin
        GetPurchr();
        //  OnUpdateDeferralAmountsOnBeforeSetDeferralPostDate(Purchr, Rec, DeferralPostDate);
        if DeferralPostDate = 0D then
            DeferralPostDate := Purchr."Posting Date";
        AdjustStartDate := true;
        if "Document Type" = "Document Type"::"Return Order" then begin
            if "Returns Deferral Start Date" = 0D then
                "Returns Deferral Start Date" := Purchr."Posting Date";
        ...
        DeferralUtilities.RemoveOrSetDeferralSchedule(
            "Deferral Code", Enum::"Deferral Document Type"::Purchase.AsInteger(), '', '',
            "Document Type".AsInteger(), "Document No.", "Line No.",
            GetDeferralAmount(), DeferralPostDate, Description, Purchr."Currency Code", AdjustStartDate);
    end;
    ...
    begin
        GetPurchr();
        if not IncomingDocument.Get(Purchr."Incoming Document Entry No.") then
            exit(false);
    ...
    begin
        ...
        if ("Inv. Discount Amount" = 0) and (xRec."Inv. Discount Amount" <> 0) and ("Line Amount" <> 0) then begin
            NotificationToSend.Id := Purchr.GetLineInvoiceDiscountResetNotificationId();
    ...
    begin
        ...
        if Purchr."Document Type" <> Purchr."Document Type"::Invoice then begin
    ...
    begin
        IsHandled := false;
        // OnBeforeCheckPrepmtAmounts(Rec, Purchr, CurrFieldNo, IsHandled, xRec);
        if IsHandled then
            exit;
        ...
        if Purchr."Document Type" <> Purchr."Document Type"::Invoice then begin
            if (("Prepmt. Line Amount" + Currency."Amount Rounding Precision") < "Prepmt. Amt. Inv.") and (Purchr.Status <> Purchr.Status::Released) then begin
    ...
    local procedure IsCalcVATAmountLinesHandled(Purchr: Record "Purchase Header"; var PurchLine: Record "Purchase Line"; var VATAmountLine: Record "VAT Amount Line"; QtyType: Option General,Invoicing,Shipping) IsHandled: Boolean
    begin
        IsHandled := false;
        OnBeforeCalcVATAmountLines(Purchr, PurchLine, VATAmountLine, IsHandled, QtyType);
        exit(IsHandled);
    end;
    ...
    var
        FromPurchaseR: Record "Purchase Request";
    begin
        if Rec."Document No." <> '' then
            FromPurchaseR := Rec.GetPurchr();
        CalculationDate := GetDateForCalculations(FromPurchaseR);
    end;

    procedure GetDateForCalculations(FromPurchasPr: Record "Purchase Request") CalculationDate: Date;
    begin
        if FromPurchasPr."Document Type" in [FromPurchasPr."Document Type"::Invoice, FromPurchasPr."Document Type"::"Credit Memo"] then
            CalculationDate := FromPurchasPr."Posting Date"
        else
            CalculationDate := FromPurchasPr."Order Date";
    ...
    [IntegrationEvent(false, false)]
    local procedure OnAfterAssignFieldsForNo(var PurchLine: Record "Purchase Line"; var xPurchLine: Record "Purchase Line"; Purchr: Record "Purchase Header")
    begin
    end;

    [IntegrationEvent(false, false)]
    local procedure OnAfterAssignHeaderValues(var PurchLine: Record "Purchase Line"; Purchr: Record "Purchase Header")
    begin
    end;
    ...
    [IntegrationEvent(false, false)]
    local procedure OnAfterAssignGLAccountValues(var PurchLine: Record "Purchase Line"; GLAccount: Record "G/L Account"; Purchr: Record "Purchase Header"; xPurchaseLine: Record "Purchase Line"; var TempPurchaseLine: Record "Purchase Line" temporary)
    begin
    end;

    [IntegrationEvent(false, false)]
    local procedure OnAfterAssignItemValues(var PurchLine: Record "Purchase Line"; Item: Record Item; CurrentFieldNo: Integer; Purchr: Record "Purchase Header")
    begin
    end;

    [IntegrationEvent(false, false)]
    local procedure OnAfterAssignItemChargeValues(var PurchLine: Record "Purchase Line"; ItemCharge: Record "Item Charge"; Purchr: Record "Purchase Header")
    begin
    end;

    [IntegrationEvent(false, false)]
    local procedure OnAfterAssignFixedAssetValues(var PurchLine: Record "Purchase Line"; FixedAsset: Record "Fixed Asset"; Purchr: Record "Purchase Header")
    begin
    end;
    ...
    [IntegrationEvent(false, false)]
    local procedure OnAfterGetPurchr(var PurchaseLine: Record "Purchase Line"; var PurchaseHeader: Record "Purchase Header"; var Currency: Record Currency)
    begin
    end;
    ...
    [IntegrationEvent(false, false)]
    local procedure OnAfterInitHeaderDefaults(var PurchLine: Record "Purchase Line"; Purchr: Record "Purchase Header"; var TempPurchLine: record "Purchase Line" temporary)
    begin
    end;
    ...
    [IntegrationEvent(false, false)]
    local procedure OnAfterInitOutstandingAmount(var PurchLine: Record "Purchase Line"; xPurchLine: Record "Purchase Line"; Purchr: Record "Purchase Header"; Currency: Record Currency)
    begin
    end;
    ...
    [IntegrationEvent(false, false)]
    local procedure OnAfterCalcVATAmountLines(var Purchr: Record "Purchase Header"; var PurchLine: Record "Purchase Line"; var VATAmountLine: Record "VAT Amount Line"; QtyType: Option General,Invoicing,Shipping)
    begin
    end;
    ...
    [IntegrationEvent(false, false)]
    local procedure OnAfterGetDeferralPostDate(var PurchaseLine: Record "Purchase Line"; Purchr: Record "Purchase Header"; var DeferralPostDate: Date);
    begin
    end;
    ...
    [IntegrationEvent(false, false)]
    local procedure OnAfterUpdateUnitCost(var PurchLine: Record "Purchase Line"; xPurchLine: Record "Purchase Line"; Purchr: Record "Purchase Header"; Item: Record Item; StockkeepingUnit: Record "Stockkeeping Unit"; Currency: Record Currency; GLSetup: Record "General Ledger Setup")
    begin
    end;
    ...
    [IntegrationEvent(false, false)]
    local procedure OnAfterUpdateVATOnLines(var Purchr: Record "Purchase Header"; var PurchLine: Record "Purchase Line"; var VATAmountLine: Record "VAT Amount Line"; QtyType: Option General,Invoicing,Shipping)
    begin
    end;
    ...
    [IntegrationEvent(false, false)]
    local procedure OnBeforeCheckPrepmtAmounts(var PurchaseLine: Record "Purchase Line"; Purchr: Record "Purchase Header"; CurrentFieldNo: Integer; var IsHandled: Boolean; xPurchaseLine: Record "Purchase Line")
    begin
    end;
    ...
    [IntegrationEvent(false, false)]
    local procedure OnBeforeCalcVATAmountLines(Purchr: Record "Purchase Header"; var PurchLine: Record "Purchase Line"; var VATAmountLine: Record "VAT Amount Line"; var IsHandled: Boolean; QtyType: Option General,Invoicing,Shipping)
    begin
    end;
    ...
    [IntegrationEvent(false, false)]
    local procedure OnBeforeGetVPGInvRoundAcc(Purchr: Record "Purchase Header"; Vendor: Record Vendor; var AccountNo: Code[20]; var IsHandled: Boolean)
    begin
    end;
    ...
    [IntegrationEvent(false, false)]
    local procedure OnCalcVATAmountLinesOnBeforeProcessPurchLine(var PurchaseLine: Record "Purchase Line"; var Purchr: Record "Purchase Header"; var VATAmountLine: Record "VAT Amount Line"; QtyType: Option General,Invoicing,Shipping)
    begin
    end;

    [IntegrationEvent(false, false)]
    local procedure OnCalcVATAmountLinesOnQtyTypeInvoicingOnBeforeCalcAmtToHandle(var PurchLine: Record "Purchase Line"; var Purchr: Record "Purchase Header"; var QtyToHandle: Decimal; var VATAmountLine: record "VAT Amount Line")
    begin
    end;
    ...
    [IntegrationEvent(false, false)]
    local procedure OnBeforeGetPurchr(var PurchaseLine: Record "Purchase Line"; var PurchaseHeader: Record "Purchase Header"; var IsHandled: Boolean; var Currency: Record Currency)
    begin
    end;
    ...
    [IntegrationEvent(false, false)]
    local procedure OnUpdateVATAmountsOnAfterCalcNormalVATAmountsForPricesIncludingVAT(var PurchaseLine: Record "Purchase Line"; Purchr: Record "Purchase Header"; Currency: Record Currency; TotalAmount: Decimal; TotalAmountInclVAT: Decimal; var PurchaseLine2: Record "Purchase Line")
    begin
    end;

    [IntegrationEvent(false, false)]
    local procedure OnUpdateVATAmountsOnAfterCalcNormalVATAmountsForPricesExcludingVAT(var PurchaseLine: Record "Purchase Line"; Purchr: Record "Purchase Header"; Currency: Record Currency; TotalAmount: Decimal; TotalAmountInclVAT: Decimal; var PurchaseLine2: Record "Purchase Line")
    begin
    end;
    ...
    [IntegrationEvent(false, false)]
    local procedure OnUpdateVATOnLinesOnBeforeProcessPurchLines(var PurchaseLine: Record "Purchase Line"; xPurchaseLine: Record "Purchase Line"; var Purchr: Record "Purchase Header"; var VATAmountLine: Record "VAT Amount Line"; var TempVATAmountLineRemainder: Record "VAT Amount Line" temporary; var LineWasModified: Boolean; var IsHandled: Boolean; QtyType: Option General,Invoicing,Shipping)
    begin
    end;

    [IntegrationEvent(false, false)]
    local procedure OnUpdateVATOnLinesOnBeforeProcessPurchLine(var PurchaseLine: Record "Purchase Line"; var Purchr: Record "Purchase Header"; var VATAmountLine: Record "VAT Amount Line"; QtyType: Option General,Invoicing,Shipping)
    begin
    end;

    [IntegrationEvent(false, false)]
    local procedure OnBeforeInitType(var PurchaseLine: Record "Purchase Line"; xPurchaseLine: Record "Purchase Line"; var Purchr: Record "Purchase Header"; var IsHandled: Boolean)
    begin
    end;
    ...
    [IntegrationEvent(false, false)]
    local procedure OnBeforeUpdateICPartner(var PurchLine: Record "Purchase Line"; GLAcc: Record "G/L Account"; var Purchr: Record "Purchase Header"; var IsHandled: Boolean)
    begin
    end;
    ...
    [IntegrationEvent(false, false)]
    local procedure OnUpdateVATOnLinesOnAfterUpdateBaseAmounts(var Purchr: Record "Purchase Header"; var PurchLine: Record "Purchase Line"; var TempVATAmountLineRemainder: Record "VAT Amount Line" temporary; var VATAmountLine: Record "VAT Amount Line"; Currency: Record Currency)
    begin
    end;
