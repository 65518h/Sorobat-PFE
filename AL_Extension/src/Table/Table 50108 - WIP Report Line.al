...
table 50061 "WIP Report Line"
{
    ...
    fields
    {
        ...
        field(6; Type; Enum "DysJob Journal Line Type")
        {
            Caption = 'Type';
        ...
        field(8; "No."; Code[20])
        {
            ...
            begin
                ...
                if ("No." = '') or ("No." <> xRec."No.") then begin
                    ...
                    // if Type = Type::Item then begin   //Remove from Enum
                    //     "Bin Code" := '';
                ...
                if not IsHandled then
                    Validate(Quantity);
                UpdateDimensions();
                Rec."Job Planning Line No." := "DysJob Planning Line No.";
            end;
        }
        ...
        field(10; Quantity; Decimal)
        {
            ...
            var
                ...
                IsHandled: Boolean;
            begin
                rec."Wip Total Line" := CalcTotalLine(Rec.Quantity, Rec.Heigth, Rec.Width, Rec.Length);
                // Rec."Wip Total Line" := 0;
                // if Rec.Quantity <> xRec.Quantity then begin
                //     Rec."Wip Total Line" := Rec.Quantity * Rec.Heigth * Rec.Width * Rec.Length;
                //     //  if Rec.Modify() then;
                // end;
        ...
        field(13; "Unit Cost (LCY)"; Decimal)
        {
            ...
            trigger OnValidate()
            begin
                // if (Type = Type::Item) and   //Remove from Enum
                //    Item.Get("No.") and
        ...
        field(18; "Unit of Measure Code"; Code[10])
        {
            ...
            begin
                ...
                // Type::"G/L Account"://Remove from Enum
                //     begin
                //         "Qty. per Unit of Measure" := 1;
        ...
        field(21; "Location Code"; Code[10])
        {
            ...
            begin
                ...
                Validate(Quantity);
                // if (Type = Type::Item) and ("Location Code" <> xRec."Location Code") then //Remove from Enum
        ...
        field(34; "Customer Price Group"; Code[10])
        {
            ...
            trigger OnValidate()
            begin
                // if (Type = Type::Item) and ("No." <> '') then //Remove from Enum
                //     UpdateAllAmounts();
            end;
        }
        field(37; "Applies-to Entry"; Integer)
        {
            ...
            begin
                InitRoundingPrecisions();
                //  TestField(Type, Type::Item);//Remove from Enum
        ...
        field(75; "Recurring Method"; Enum "Dys Wip Line Recurring")
        {
            BlankZero = true;
        ...
        field(50007; "DysJob Planning Line No."; Integer)
        {
            ...
            begin
                Validate("Job Planning Line No.", "DysJob Planning Line No.");
                if RecJobPlanningLine.Get(Rec."Job No.", Rec."Job Task No.", Rec."DysJob Planning Line No.") then begin
                    Rec.Validate("Unit Cost", RecJobPlanningLine."Unit Cost");
                    Rec."Description 2" := RecJobPlanningLine.Description;
                end;
        ...
        field(50100; "Length"; Decimal)
        {
            ...
            begin
                rec."Wip Total Line" := CalcTotalLine(Rec.Quantity, Rec.Heigth, Rec.Width, Rec.Length);
                // Rec."Wip Total Line" := 0;
                // if Rec.Length <> xRec.Length then begin
                //     Rec."Wip Total Line" := Rec.Quantity * Rec.Heigth * Rec.Width * Rec.Length;
                //     Rec.Modify();
        ...
        field(50101; "Width"; Decimal)
        {
            ...
            begin
                rec."Wip Total Line" := CalcTotalLine(Rec.Quantity, Rec.Heigth, Rec.Width, Rec.Length);
                // Rec."Wip Total Line" := 0;
                // if Rec.Width <> xRec.Width then begin
                //     Rec."Wip Total Line" := Rec.Quantity * Rec.Heigth * Rec.Width * Rec.Length;
                //     Rec.Modify();
                // end;
            end;
        }
        field(50102; "Heigth"; Decimal)
        {
            Caption = 'Heigth';
            trigger OnValidate()
            var
            begin
                rec."Wip Total Line" := CalcTotalLine(Rec.Quantity, Rec.Heigth, Rec.Width, Rec.Length);
                // Rec."Wip Total Line" := 0;
                // if Rec.Heigth <> xRec.Heigth then begin
                //     Rec."Wip Total Line" := Rec.Quantity * Rec.Heigth * Rec.Width * Rec.Length;
                //     Rec.Modify();
        ...
        field(50103; "Wip Total Line"; Decimal)
        {
            Caption = 'Total lines WIP';
            Editable = false;
        }
        field(50104; "Resource Number"; Integer)
        {
            Caption = 'Nombre de person';
        ...
        field(50107; "Executed Unit of Measure Code"; Code[20])
        {
            Caption = 'Executed Unit of Measure Code';
            FieldClass = FlowField;
            CalcFormula = lookup("Job Task"."Initial Unit Of Measure" where("Job No." = field("Job No."), "Job Task No." = field("Job Task No.")));
        }
        field(50106; Bin; Text[100])
        {
            Caption = 'Observation';
            DataClassification = ToBeClassified;
        }
    ...
    procedure CalcTotalLine(Qty: Decimal; Len: Decimal; Wid: Decimal; Hei: Decimal): Decimal
    var
        TotResult: Decimal;
    begin
        TotResult := Qty;
        if len <> 0 then
            TotResult := TotResult * Len;
        if Wid <> 0 then
            TotResult := TotResult * Wid;
        if Hei <> 0 then
            TotResult := TotResult * Hei;
        exit(TotResult);
    ...
    begin
        ...
        // if (CurrFieldNo <> 0) and (Type = Type::Item) and (Quantity > 0) and not CheckedAvailability then begin //Remove from Enum
    ...
    begin
        //Remove from Enum  TestField(Type, Type::Item);
        TestField("No.");
    ...
    begin
        ...
        if RecJobPlanningLine.Get(Rec."Job No.", Rec."Job Task No.", Rec."DysJob Planning Line No.") then begin
            "Unit Cost" := RecJobPlanningLine."Unit Cost";
    ...
    begin
        ...
        // if (Type = Type::Item) and Item.Get("No.") then begin //Remove from Enum
        //     if Item."Costing Method" = Item."Costing Method"::Standard then begin
    ...
    begin
        ...
        case Type of
            // Type::Item:
            //     if ("No." <> xRec."No.") or //Remove from Enum
    ...
    begin
        ...
        JobJournalLine.TransferFields(Rec);
        if not JobJournalLine.Insert() then
            JobJournalLine.Modify();
        LineWithPrice.SetLine(PriceType, JobJournalLine);
        PriceCalculationMgt.GetHandler(LineWithPrice, PriceCalculation);
        PriceCalculation.ApplyPrice(CalledByFieldNo);
        if PriceType = PriceType::Sale then
            PriceCalculation.ApplyDiscount();
        PriceCalculation.GetLine(Line);
        Rec.TransferFields(Line);
    ...
    begin
        // if Type <> Type::Item then //Remove from Enum
        //     exit(false);
        // if "No." = '' then
        //     exit(false);
        // GetItem();
